...
class FooterSpec extends AnyWordSpec with Matchers with GuiceOneAppPerSuite {

  "Footer" must {
    "contain links to assets-frontend JS" in new CommonSetup {
      override lazy val inputMap = Map[String, Any]()
      outputText must include ("""<script src="http://localhost:9032/assets/3.19.0/javascripts/application.min.js" type="text/javascript"></script>""")
    }
