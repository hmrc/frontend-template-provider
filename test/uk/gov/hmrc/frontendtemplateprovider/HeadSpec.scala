...
class HeadSpec extends UnitSpec with OneAppPerSuite {
  ...
  "Head" should {
    ...
    "contain links to assets-frontend CSS" in new CommonSetup {
      override lazy val inputMap = Map[String, Any]()
      outputText should include("""<link rel="stylesheet" href="http://localhost:9032/assets/3.2.2/stylesheets/application-ie7.min.css" />""")
      outputText should include("""<link rel="stylesheet" href="http://localhost:9032/assets/3.2.2/stylesheets/application-ie.min.css" />""")
      outputText should include("""<link rel="stylesheet" href="http://localhost:9032/assets/3.2.2/stylesheets/application.min.css" />""")
    }
